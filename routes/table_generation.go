...
func (srv *Server) tableGeneration(footer string) {
	srv.router.GET("/production/tableGeneration.html", func(c *gin.Context) {
	...
	srv.router.POST("/production/tableGeneration.html", func(c *gin.Context) {
		header, _ := templates.RenderHeader(c)
		var q searchQuery
		err := c.ShouldBind(&q)
...
func (srv *Server) tableGenerationWithError(c *gin.Context, header, footer, alertMsg string, q searchQuery) {
	...
	c.HTML(http.StatusOK, "tableGeneration.html", gin.H{
